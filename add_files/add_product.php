...
if(isset($_POST['submit'])){
        ...
        $workbench_id=$_POST["workbench_id"];
          ...
          $sql = "INSERT INTO products ( product_name, quantity, unit,workbench_id) 
          VALUES ( '$product_name', '$quantity', '$unit','$workbench_id')";
...
<div>
  <form action="add_product.php" method="post">
    ...
    <input type="text"  name="workbench_id" placeholder="Workbench">
        </td>
    </tr>
