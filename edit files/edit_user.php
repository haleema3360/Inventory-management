...
<div class="box">
<div>
  <form action="modify_user.php?editid=<?= $user_id ?>" method="post">
      <table>
  <tr>
    <td>
  ...
  <tr>
    ...
    <input type="text"  name="workstation" placeholder="Workstation assigned" value="<?= $data['workstation']?>">
    </td>
  ...
  <tr>
    ...
    <input type="text"  name="designation" placeholder="designation" value="<?= $data['designation']?>">
    </td>
