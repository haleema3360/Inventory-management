...
<div class="content"> 
<h2 class="heading">Edit Product Order</h2>
<div class="box">
<div>
  <form action="modify_po.php?editid=<?= $product_id?>" method="post">
   ...
   <select name="status">
                        ...
                        <option>WIP Inventory</option>
                        <option>Finished Goods Inventory</option>
    ...
    <input type="text"  name="ordered_date" placeholder="Ordered on" value="<?= $data['ordered_date']?>">
            </td>
        </tr>
    </table>
    <br>
