...
<div class="box">
<div>
  <form action="modify_workbench.php?editid=<?= $id ?>" method="post">
      
      <table>
  <tr>
    <td>
     <label>Workbench ID</label><br> 
    <input type="text"  name="id" placeholder="workbench ID" value="<?= $data['id']?>">
    </td>
    <td>
  ...
  <select name="status">
    ...
    <input type="text"  name="duration" placeholder="Duration" value="<?= $data['duration']?>">
    </td>
