...
<?php
    ...
    $r=mysqli_query($conn,"SELECT `user_id` FROM `admin` WHERE username='$username'");
    if (!$r) {
   printf("Error: %s\n", mysqli_error($conn));
   //exit();
 }
 ...
 echo'<td> <h3><u>Profile</u></h3></td>
             <td class="pencil"><button type="button" class="btn btn-link">
                <a href="edit_admin_info.php?editid='.$id.'">  <span class="bi bi-pencil-fill"></span></a></button></td>
