       ...
       $reciever=$row['receiver'];
          echo '<tr>
              ...
              <td>'.$row["workstation_from"].'</td>
               ...
               <td>
               <button type="button" class="btn btn-success"> <a class="but" href="push_fg.php?pushid='.$batch_id.'"> Done</a></button>
               <button type="button" class="btn btn-link"> <a href="edit_wip.php?editid='.$batch_id.'">  <span class="bi bi-pencil-fill"></span></a></button>
               <button type="button" class="btn btn-link"><a href="delete_wip.php?deleteid='.$batch_id.'"> <span class="bi bi-trash"></span></button></td>
